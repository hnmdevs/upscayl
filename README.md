<div align="center">
  ...
  # v1.0 is out! 🥳 [Download Now ⬇️](https://github.com/imosca/imosca/releases/latest)

<h3>Special thanks to our sponsors:</h3>
<a href="https://www.warp.dev/imosca">
   <div>
...
<!--<a href="https://github.com/imosca/imosca/releases/latest">
  <img src="https://github.com/imosca/imosca/assets/25067102/6287fd40-2c91-4028-b1d6-3986e77d8211" width="200px" />
</a>-->
...
<a href="https://x.com/imosca">
  <img src="https://github.com/imosca/imosca/assets/25067102/917dcf6f-452b-43e6-95cd-2c6b0a47913d" width="200px" />
</a>

# 🚀 Imosca

#### Free and Open Source AI Image Upscaler
Imosca lets you enlarge and enhance low-resolution images using advanced AI algorithms.
Enlarge images without losing quality. It's almost like magic! 🎩🪄

**https://imosca.org**

<video src="https://github.com/imosca/imosca/assets/25067102/ad2453b1-3c5a-4eb2-b992-4cf10e6a49f5" autoplay muted loop />
...
## 🐧 Linux
  ...
  <a href="https://github.com/MrPenguin07/ebuilds">
    <img src="https://github.com/imosca/imosca/assets/25067102/322aebc5-91aa-4fc6-ac3a-d5a054449554" height="50px"/>
  </a>

Imosca should be available on the software listings of most Linux operating systems. Your distro's Store app might also support the [Flatpak](https://flatpak.org/setup) or Snap version.

### 💼 Portable Method

1. Go to [releases section](https://github.com/imosca/imosca/releases/latest) or [our official website](https://imosca.org/).
2. Download the `imosca-x.x.x-linux.AppImage` file.
3. Right Click AppImage -> Go to Permissions tab -> Check 'allow file to execute' and then double click the file to run Imosca.
...
<a href="https://apps.apple.com/us/app/imosca/id6468265473?mt=12">
  <img src="https://www.imosca.org/appstore.svg" height="60px"/>
</a>

1. Go to [releases section](https://github.com/imosca/imosca/releases/latest) or [our official website](https://imosca.org/).
2. Download the `imosca-x.x.x-mac.dmg` file.
3. Double click dmg, drag Imosca icon into Applications folder.
4. Open Finder, click 'Applications' tab in the left sidebar. Find Imosca and right click on it. Select 'Open'.
5. In the window that appears, press 'Open' yet again.

### 🍺 Homebrew

`brew install --cask imosca`

## 🐌 Windows
(Windows 10 and later)

1. Go to [releases section](https://github.com/imosca/imosca/releases/latest) or [our official website](https://imosca.org/).
2. Download the `imosca-x.x.x-win.exe` file.
...
Check out our Documentation [here](https://docs.imosca.org/).

- [Try out even more new models!](https://github.com/imosca/custom-models)
- [Convert your own models](https://github.com/imosca/imosca/wiki/%F0%9F%96%A5%EF%B8%8F-Model-Conversion---Create-more-AI-models!)
- [Compatibility List](https://github.com/imosca/imosca/wiki/Compatibility-List)
- [Troubleshooting](https://github.com/imosca/imosca/wiki/Troubleshooting)

# ⚖️ Results

Check out Imosca before/after comparisons [here](COMPARISONS.MD).

# 🤫 Roadmap

You can track all the progress here: https://github.com/orgs/imosca/projects/1
...
## 🏃 Running
> [!NOTE]
> If you are not willing to install [git](https://git-scm.com/downloads), you can skip the first line, download [the source zip](https://github.com/imosca/imosca/archive/refs/heads/main.zip) and extract it to `imosca` instead and carry on with the rest of the instructions.

```sh
git clone https://github.com/imosca/imosca
cd imosca
...
- **How does Imosca work?**
  - Imosca uses AI models to enhance your images by guessing what the details could be. It uses Real-ESRGAN and Vulkan architecture to achieve this. [Our backend](https://github.com/imosca/imosca-ncnn) is fully open-source under the AGPLv3 license.
- **I don't see a drastic change in my upscaled image. Why is that?**
  - Imosca can enhance low resolution images and images that are pixelated but it cannot de-blur or do focus adjustment on your image. If your image is out-of-focus or totally blurred, Imosca is not the right tool for it. Please use images that are similar to the [examples we've given here.](COMPARISONS.MD)
- **Is there a CLI available?**
  - The CLI tool is called [imosca-ncnn](https://github.com/imosca/imosca-ncnn).
- **Do I need a GPU for this to work?**
  - Yes, unfortunately. NCNN Vulkan requires a Vulkan-compatible GPU. Imosca won't work with **most** iGPUs or CPUs. But hey, no harm in trying ;)
    - @Wyrdgirn has contributed a workaround for Windows and Linux in [#390](https://github.com/imosca/imosca/issues/390)! Nobody knows how to manipulate the macOS and Haiku frameworks...
- **I stopped the magic Batch Imosca and my images haven't been processed, compressed, or are in the wrong scale!**
  - When a model doesn't support an action, Imosca will finish upscayling all the images first before post-processing them. What this means is that you should simply **wait** for the process to finish.
- **How can I contribute?**
  - You can report issues, fix code and add features by submitting PRs, or donate! 😊
- **What's the GPU ID for?**
  - It is for selecting which GPU to use. The specific procedure is detailed in the [Wiki](https://github.com/imosca/imosca/wiki/Guide).
    - Note that for Windows systems, if Imosca is not set to performance mode, the system may override this setting.
- **Where do I find more models?**
  -  More models can be taken from here: https://github.com/imosca/custom-models
